...
\textbf{Density W.} & 9.231          & 34.61             & 0.434                      \\
\textbf{Queue W.}   & 9.344 & 36.62             & 1.288                      \\
\textbf{Flow W.}    & 9.536          & 35.81             & 0.3752                     \\
\textbf{Dynamic}    & 6.015          & 36.75             & 0.0943                     \\
\textbf{Dynamic+}   & 11.29          & 134.06            & 0.325                     
\end{tabular}
\end{table}
...
\textbf{Density W.} & 8.9365           & 26.867            & 0.2742                     \\
\textbf{Queue W.}   & 8.902            & 28.91             & 0.811                      \\
\textbf{Flow W.}    & 9.105            & 28.58             & 0.2642                     \\
\textbf{Dynamic}    & 5.9756           & 27.924            & 0.0824                     \\
\textbf{Dynamic+}   & 9.9371           & 110.38            & 0.1399                    
\end{tabular}
\end{table}
...
\textbf{Density W.} & 0.1409          & 0.014             & 0.0002                     \\
\textbf{Queue W.}   & 0.1332          & 0.0137            & 0.0004                     \\
\textbf{Flow W.}    & 0.1326          & 0.0139            & 0.0001                     \\
\textbf{Dynamic}    & 0.242           & 0.242             & 0.0004                     \\
\textbf{Dynamic+}   & 0.0930          & 0.012             & 0.0002                    
\end{tabular}
\end{table}
...
\textbf{Density W.} & 0.1383           & 0.0123            & 0.0001                     \\
\textbf{Queue W.}   & 0.1327           & 0.0118            & 0.0001                     \\
\textbf{Flow W.}    & 0.1310           & 0.0119            & 0.0001                     \\
\textbf{Dynamic}    & 0.252            & 0.0128            & 0.0002                     \\
\textbf{Dynamic+}   & \textbf{0.10620} & 0.0121            & 0.0000                    
\end{tabular}
\end{table}
...
\textbf{Informed}         & 9.86          & 90.13             & 0.240                      \\
\textbf{Density W.} & 8.46          & 20.80             & 0.304                      \\
\textbf{Queue W.}   & 7.55          & 20.07             & 0.649                      \\
\textbf{Flow W.}    & 9.00          & 23.02             & 0.239                      \\
\textbf{Dynamic}          & 1.99          & 3.997             & 0.073                      \\
\textbf{Dynamic+}         & -             & -                 & -                    
\end{tabular}
\end{table}
...
\textbf{Density W.} & 8.471          & 15.78             & 0.263                      \\
\textbf{Queue W.}   & 7.534          & 15.55             & 0.352                      \\
\textbf{Flow W.}    & 9.198          & 17.50             & 0.177                      \\
\textbf{Dynamic}          & 1.868          & 2.564             & 0.032                      \\
\textbf{Dynamic+}         & -              & -                 & -                         
\end{tabular}
\end{table}
...
\textbf{Density W.} & 0.1607         & 0.0119            & 0.0002                     \\
\textbf{Queue W.}   & 0.159          & 0.0123            & 0.0005                     \\
\textbf{Flow W.}    & \textbf{0.139} & 0.010             & 0.0002                     \\
\textbf{Dynamic}    & 0.2387         & 0.0156            & 0.0019                     \\
\textbf{Dynamic+}   & -              & -                 & -                         
\end{tabular}
\end{table}
...
\textbf{Density W.} & 0.1808         & 0.0104            & 0.0001                     \\
\textbf{Queue W.}   & 0.1817         & 0.011             & 0.0001                     \\
\textbf{Flow W.}    & \textbf{0.154} & 0.009             & 0.0001                     \\
\textbf{Dynamic}    & 0.2814         & 0.012             & 0.0001                     \\
\textbf{Dynamic+}   & -              & -                 & -                         
\end{tabular}
\end{table}
...
\textbf{Density W.} & 8.482          & 28.14             & 0.365                      \\
\textbf{Queue W.}   & 8.182          & 29.41             & 1.596                      \\
\textbf{Flow W.}    & \textbf{9.002} & 31.77             & 0.328                      \\
\textbf{Dynamic}          & 1.503          & 2.983             & 0.054                      \\
\textbf{Dynamic+}         & 1.574          & 3.251             & 0.078                   
\end{tabular}
\end{table}
...
\textbf{Density W.} & 7.481          & 22.69             & 0.295                      \\
\textbf{Queue W.}   & 7.803          & 23.47             & 1.735                      \\
\textbf{Flow W.}    & \textbf{7.826} & 23.13             & 0.261                      \\
\textbf{Dynamic}          & 1.399          & 1.932             & 0.030                      \\
\textbf{Dynamic+}         & 1.745          & 3.031             & 0.038                     
\end{tabular}
\end{table}
...
\textbf{Density W.} & 0.1520          & 0.0127            & 0.0004                     \\
\textbf{Queue W.}   & \textbf{0.1467} & 0.0132            & 0.0006                     \\
\textbf{Flow W.}    & 0.1475          & 0.01287           & 0.0002                     \\
\textbf{Dynamic}    & 0.2565          & 0.01699           & 0.0035                     \\
\textbf{Dynamic+}   & 0.2284          & 0.014             & 0.0040                    
\end{tabular}
\end{table}
...
\textbf{Density W.} & 0.1221          & 0.009             & 0.0001                     \\
\textbf{Queue W.}   & \textbf{0.1119} & 0.0094            & 0.0001                     \\
\textbf{Flow W.}    & 0.1202          & 0.010             & 0.0001                     \\
\textbf{Dynamic}    & 0.2193          & 0.0108            & 0.0001                     \\
\textbf{Dynamic+}   & 0.1762          & 0.0100            & 0.0001                    
\end{tabular}
\end{table}
